...
public class WxPayController {
	...
	public ModelAndView wechatH5pay(HttpServletRequest request, Map<String, Object> map)  throws Exception {
		...
		try {
			...
			orderRequest.setNotifyUrl(appConfiguration.getServerUrl()+"/payNotify");
		...
		return new ModelAndView("wechatH5pay", map);
	}
