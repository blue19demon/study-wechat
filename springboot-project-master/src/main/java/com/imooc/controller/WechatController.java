...
//        WxMpService wxMpService=new WxMpServiceImpl();
    ...
    public String userInfo(@RequestParam("code") String code,
        ...
        try {
        	...
        	log.info("【微信网页授权】获取wxMpUser={}",JsonUtil.toJson(wxMpUser));
        	WxMpTemplateMessage templateMessage = new WxMpTemplateMessage();
        	templateMessage.setTemplateId("URxUnbbPIuj099nVL1cjgAw49IQnFmcaPTo7irDZjrY");
        	templateMessage.setUrl("http://www.baidu.com");
        	templateMessage.setToUser(openId);
        	templateMessage.setData(Arrays.asList(
        			new WxMpTemplateData("title", "您已登陆成功"),
        			new WxMpTemplateData("name", wxMpUser.getNickname()),
        			new WxMpTemplateData("login_time",DateUtil.now())));
